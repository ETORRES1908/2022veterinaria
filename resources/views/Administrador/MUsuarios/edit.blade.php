                ...
                <div class="text-center">
                    ...
                    <div class="mb">
                        <form method="POST" action="{{ route('usuarios.update', ['id' => $user->id]) }}">
                            ...
                            <select class="col-xs-6 mb form-control text-danger" name="status"
                    ...
                    <div class="col-xs-12">
                        <div class="row mb">
                            ...
                            <div class="col-xs-6 text-center">
                                <img class="img-responsive center-block" src="{{ asset($user->fdpt) }}"
                                    style="height:200px">
                            </div>
                            <div class="col-xs-6 text-center">
                                <img class="img-responsive center-block" src="{{ asset($user->sdpt) }}"
                                    style="height:200px">
                            </div>
                        </div>
                    </div>
